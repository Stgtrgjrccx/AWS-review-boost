...
export default function ProspectsPage() {
  ...
  const [form, setForm] = useState({
    ...
    websiteStatus: 'No mobile-optimized website',
  ...
  const generateWhatsAppLink = (p) => {
    ...
    const msg = encodeURIComponent(
      ...
      `I saw ${p.businessName} on Google Maps in ${p.city}. You currently have ${p.currentRating}★. We run reputation shielding and high-speed mobile websites for Pune businesses.\n\n` +
      `Here is a live demonstration of how we shield from 1-star reviews & drive 5-stars: ${typeof window !== 'undefined' ? window.location.origin : ''}/live/peshwa-restaurant\n\n` +
      `Would you be open to a 2-minute preview tailored for ${p.businessName}?`
    )
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 14 }}>
        <div>
          ...
          <p style={{ color: '#94a3b8', margin: '4px 0 0 0', fontSize: 13, letterSpacing: '-0.01em' }}>
            Verified Pune businesses with &lt; 4.0 Google ratings and weak digital assets.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 26 }}>
        <div className="liquid-glass" style={{ padding: '20px 22px' }}>
          ...
          <div style={{ fontSize: 12, color: '#94a3b8', marginTop: 4 }}>Pune Local Businesses</div>
        </div>
        ...
        <div className="liquid-glass" style={{ padding: '20px 22px' }}>
          ...
          <div style={{ fontSize: 12, color: '#fbbf24', marginTop: 4 }}>Critical &lt; 3.8★ Rating</div>
        </div>
        ...
        <div className="liquid-glass" style={{ padding: '20px 22px' }}>
          ...
          <div style={{ fontSize: 12, color: '#38bdf8', marginTop: 4 }}>In active conversation</div>
        </div>
        ...
        <div className="liquid-glass" style={{ padding: '20px 22px' }}>
          ...
          <div style={{ fontSize: 12, color: '#10b981', marginTop: 4 }}>Managed Properties</div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 22, flexWrap: 'wrap', gap: 12 }}>
        ...
        <input
          ...
          style={{ width: 240, padding: '8px 14px', fontSize: 12 }}
        />
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <span style={{ color: '#cbd5e1', fontWeight: 500, textAlign: 'right', maxWidth: 190, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {p.websiteStatus}
                  </span>
                </div>
