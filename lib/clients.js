...
// =============================================================
// ACTIVE MANAGED CLIENT PROPERTIES (VERIFIED PUNE BUSINESSES ONLY)
// =============================================================
let defaultClients = [
  {
    id: 'client-peshwa',
    name: 'Peshwa Restaurant',
    slug: 'peshwa-restaurant',
    industry: 'restaurant',
    phone: '+91 98224 55661',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJPeshwaFCRoadPunePlaceId',
    brandColor: '#ea580c',
    status: 'active',
    liveToken: 'pshw_9921',
    ...
    website: {
      status: 'live',
      domain: 'https://peshwafcroad.in',
      stagingUrl: 'https://peshwa.preview.asw.agency',
      techStack: 'Next.js 15, Tailwind, Cal.com API',
      type: 'Live Queue Token Status & Mobile Menu App',
      monthlyVisitors: 16400,
      speedScore: 99,
      leadsCaptured: 54,
      uptime: '99.98%',
      ssl: 'Active 🟢',
      lastDeployed: 'Yesterday, 6:15 PM',
      pendingTasks: ['Morning Misal Special banner', 'Weekend takeaway pre-order system'],
    },
    reviewsSent: 410,
    fiveStarCount: 312,
    fourStarCount: 48,
    ...
    recentActivity: [
      { id: 'act-p1', type: 'five_star', customer: 'Sarang Kulkarni', time: '8 mins ago', note: '5★ Google Review verified' },
      { id: 'act-p2', type: 'web_lead', customer: 'Tanvi Patwardhan', time: '24 mins ago', note: 'Table booking confirmed for 4 guests' },
      { id: 'act-p3', type: 'intercepted', customer: 'Abhishek Gadre', time: '1 hour ago', note: '2★ Shielded privately (Wait time issue)' },
      { id: 'act-p4', type: 'sent', customer: 'Pooja Deshpande', time: '2 hours ago', note: 'WhatsApp review invite delivered' },
    ],
    customerPraises: [
      'Authentic Puneri misal with perfect tarri and pav! Service was super fast.',
      'Clean hygiene and courteous staff on FC Road. Highly recommended.',
      'Great ambiance for traditional Maharashtrian breakfast.',
    ],
    interceptedFeedback: [
      { id: 'fb-p1', customer: 'Abhishek Gadre', phone: '+91 98220 11990', rating: 2, tags: ['Table Wait ⏳'], comment: 'Waited 25 mins on Sunday morning. Food was great though.', time: '1 hour ago', resolved: false }
    ]
  },
  {
    id: 'client-capital-saloon',
    name: 'Capital Saloon',
    slug: 'capital-saloon',
    industry: 'salon',
    phone: '+91 98221 66554',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJCapitalSaloonKothrudPlaceId',
    brandColor: '#0284c7',
    status: 'active',
    liveToken: 'cap_4412',
    ...
    website: {
      status: 'live',
      domain: 'https://capitalsaloon.in',
      stagingUrl: 'https://capital-saloon.preview.asw.agency',
      techStack: 'Next.js 15, Framer Motion, Slot Booking Engine',
      type: 'Hair & Grooming Appointment Booking Web App',
      monthlyVisitors: 9800,
      speedScore: 98,
      leadsCaptured: 76,
      uptime: '100%',
      ssl: 'Active 🟢',
      lastDeployed: 'May 31, 2026',
      pendingTasks: ['Stylist schedule sync', 'VIP membership cards rollout'],
    },
    reviewsSent: 628,
    fiveStarCount: 485,
    fourStarCount: 65,
    ...
    recentActivity: [
      { id: 'act-c1', type: 'web_lead', customer: 'Nikhil Ranade', time: '12 mins ago', note: 'Haircut & beard trim appointment booked' },
      { id: 'act-c2', type: 'five_star', customer: 'Rahul Bhende', time: '35 mins ago', note: '5★ Google Review verified' },
      { id: 'act-c3', type: 'sent', customer: 'Aditya Sane', time: '1 hour ago', note: 'Post-haircut WhatsApp review request sent' },
    ],
    customerPraises: [
      'Best fade haircut in Kothrud! Stylist Mahesh is brilliant.',
      'Online appointment system saved me 45 minutes of waiting time.',
    ],
    interceptedFeedback: []
  },
  {
    id: 'client-yogi-tree',
    name: 'Yogi Tree Restaurant & Cafe',
    slug: 'yogi-tree',
    industry: 'restaurant',
    phone: '+91 98231 77884',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJYogiTreeKoregaonParkPlaceId',
    brandColor: '#16a34a',
    status: 'active',
    liveToken: 'yogi_7719',
    address: 'Lane A, North Main Road, Koregaon Park, Pune',
    website: {
      status: 'review',
      domain: 'https://yogitreecafe.in',
      stagingUrl: 'https://yogi-tree.preview.asw.agency',
      techStack: 'Next.js 15, Tailwind, Touch Menu QR',
      type: 'Mobile-First Digital QR Menu & Table Reservation',
      monthlyVisitors: 12200,
      speedScore: 99,
      leadsCaptured: 38,
      uptime: '99.99%',
      ssl: 'Active 🟢',
      lastDeployed: 'June 1, 2026',
      pendingTasks: ['Organic beverage section highlight', 'Sunday live music banner'],
    },
    reviewsSent: 310,
    fiveStarCount: 235,
    fourStarCount: 38,
    ...
    recentActivity: [
      { id: 'act-y1', type: 'five_star', customer: 'Maya Chitnis', time: '18 mins ago', note: '5★ Google Review verified' },
      { id: 'act-y2', type: 'web_lead', customer: 'David Miller', time: '45 mins ago', note: 'Outdoor garden table reserved for 2' },
    ],
    customerPraises: [
      'Peaceful garden setting in Koregaon Park. Herbal teas are world class.',
      'Love the new smartphone QR menu. Very convenient!',
    ],
    interceptedFeedback: []
  },
  {
    id: 'client-amazing-salon',
    name: 'Amazing Beauty Salon',
    slug: 'amazing-beauty-salon',
    industry: 'salon',
    phone: '+91 98230 44551',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJAmazingSalonBavdhanPlaceId',
    brandColor: '#db2777',
    status: 'active',
    liveToken: 'amz_1102',
    address: 'Near LMD Chowk, Bavdhan, Pune',
    website: {
      status: 'live',
      domain: 'https://amazingbeautysalon.in',
      stagingUrl: 'https://amazing-salon.preview.asw.agency',
      techStack: 'Next.js 15, Tailwind, Modern Glassmorphic Portfolio',
      type: 'Bridal Packages Showcase & Instant Booking',
      monthlyVisitors: 5400,
      speedScore: 97,
      leadsCaptured: 31,
      uptime: '99.95%',
      ssl: 'Active 🟢',
      lastDeployed: 'May 29, 2026',
      pendingTasks: ['Bridal portfolio shoot upload', 'Pre-monsoon hair spa offer'],
    },
    reviewsSent: 85,
    fiveStarCount: 62,
    fourStarCount: 11,
    ...
    avgRating: 3.6,
    conversionRate: 82,
    monthMetrics: { reviewsSent: 22, fiveStarCount: 18, fourStarCount: 2, interceptedCount: 1, avgRating: 4.82, conversionRate: 86 },
    weekMetrics: { reviewsSent: 8, fiveStarCount: 7, fourStarCount: 1, interceptedCount: 0, avgRating: 5.0, conversionRate: 92 },
    recentActivity: [
      { id: 'act-a1', type: 'five_star', customer: 'Snehal Jagtap', time: '30 mins ago', note: '5★ Google Review verified' },
      { id: 'act-a2', type: 'web_lead', customer: 'Pooja Kadam', time: '1 hour ago', note: 'Bridal consultation inquiry captured' },
    ],
    customerPraises: [
      'Hair botox treatment done by Pooja was outstanding! ⭐',
      'Clean studio and zero waiting time with the new appointment system.',
    ],
    interceptedFeedback: []
  },
  {
    id: 'client-lotus-bistro',
    name: 'The Lotus Bistro',
    slug: 'lotus-bistro',
    industry: 'restaurant',
    phone: '+91 98209 88112',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJLotusBistroKPPlaceId',
    brandColor: '#8b5cf6',
    status: 'active',
    liveToken: 'lot_5521',
    ...
    website: {
      status: 'live',
      domain: 'https://lotusbistrokp.com',
      stagingUrl: 'https://lotus-bistro.preview.asw.agency',
      techStack: 'Next.js 15, Framer Motion, Luxury Dining UI',
      type: 'Fine-Dine Food Showcase & Private VIP Reservations',
      monthlyVisitors: 11800,
      speedScore: 98,
      leadsCaptured: 49,
      uptime: '100%',
      ssl: 'Active 🟢',
      lastDeployed: 'Yesterday, 3:00 PM',
      pendingTasks: ['Signature sushi platter photography', 'Chef special wine pairing menu'],
    },
    reviewsSent: 215,
    fiveStarCount: 168,
    fourStarCount: 28,
    ...
    avgRating: 3.9,
    conversionRate: 86,
    monthMetrics: { reviewsSent: 46, fiveStarCount: 39, fourStarCount: 4, interceptedCount: 1, avgRating: 4.90, conversionRate: 90 },
    weekMetrics: { reviewsSent: 15, fiveStarCount: 13, fourStarCount: 1, interceptedCount: 0, avgRating: 5.0, conversionRate: 94 },
    recentActivity: [
      { id: 'act-l1', type: 'web_lead', customer: 'Vikramaditya Rao', time: '15 mins ago', note: 'Private candlelight dinner reservation for 2' },
      { id: 'act-l2', type: 'five_star', customer: 'Ananya Shroff', time: '50 mins ago', note: '5★ Google Review verified' },
    ],
    customerPraises: [
      'Exquisite culinary experience in Lane 5. The wood-fired gnocchi is divine.',
  ...
  {
    id: 'client-swaadesi',
    name: 'Swaadesi Restaurant',
    slug: 'swaadesi-restaurant',
    industry: 'restaurant',
    phone: '+91 98235 44119',
    googleReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJSwaadesiBanerPlaceId',
    brandColor: '#f59e0b',
    status: 'active',
    liveToken: 'swad_3311',
    ...
    website: {
      ...
      domain: 'https://swaadesibaner.com',
      stagingUrl: 'https://swaadesi.preview.asw.agency',
      techStack: 'Next.js 15, Tailwind, Corporate Catering Portal',
      type: 'Corporate Dining, Table Booking & Catering Funnel',
      monthlyVisitors: 8600,
      speedScore: 97,
      leadsCaptured: 34,
      uptime: '99.96%',
      ssl: 'Active 🟢',
      lastDeployed: 'June 2, 2026',
      pendingTasks: ['IT park corporate lunch pass module', 'Private party banquet enquiry form'],
    },
    reviewsSent: 380,
    fiveStarCount: 290,
    fourStarCount: 45,
    ...
    avgRating: 3.9,
    conversionRate: 84,
    monthMetrics: { reviewsSent: 60, fiveStarCount: 51, fourStarCount: 5, interceptedCount: 2, avgRating: 4.88, conversionRate: 88 },
    weekMetrics: { reviewsSent: 18, fiveStarCount: 16, fourStarCount: 1, interceptedCount: 0, avgRating: 5.0, conversionRate: 94 },
    recentActivity: [
      { id: 'act-s1', type: 'web_lead', customer: 'Infosys Team (Baner)', time: '20 mins ago', note: 'Corporate lunch buffet booked for 18 guests' },
      { id: 'act-s2', type: 'five_star', customer: 'Nilesh Tambe', time: '1 hour ago', note: '5★ Google Review verified' },
    ],
    customerPraises: [
      'Best butter chicken and dal makhani on Baner Road.',
      'Great corporate discount and very fast table service.',
    ],
    interceptedFeedback: []
  }
]
...
export function createClient({ name, slug, industry, googleReviewUrl, phone, brandColor, websiteDomain, websiteType }) {
  ...
  const newClient = {
    ...
    brandColor: brandColor || '#38bdf8',
    status: 'active',
    liveToken: token,
    website: {
      status: 'in_development',
      domain: websiteDomain || `https://${newSlug}.in`,
      stagingUrl: `https://${newSlug}.preview.asw.agency`,
      techStack: 'Next.js 15, Tailwind, Apple Liquid Glass UI',
      type: websiteType || 'Business Showcase & Lead Funnel',
      monthlyVisitors: 0,
      speedScore: 99,
      leadsCaptured: 0,
      uptime: '100%',
      ssl: 'Active 🟢',
      lastDeployed: 'Just initialized',
      pendingTasks: ['Initial design setup', 'Connect domain & SSL certificate'],
    },
    reviewsSent: 0,
    fiveStarCount: 0,
    fourStarCount: 0,
    ...
    recentActivity: [
      { id: `act-${Date.now()}`, type: 'system', customer: 'System', time: 'Just now', note: 'Client account & website initialized' }
    ],
    customerPraises: [],
    interceptedFeedback: []
  }
...
// =============================================================
// VERIFIED PUNE PROSPECTS STORE (< 4.0 STARS & WEAK WEBSITES)
// =============================================================
let defaultProspects = [
  ...
  },
  {
    ...
    notes: "Follow up with screenshot of Capital Saloon live portal."
  },
  {
    id: "prospect-4",
...
export function createProspect(data) {
  const newProspect = {
    ...
    currentRating: Number(data.currentRating) || 3.8,
    currentReviewsCount: Number(data.currentReviewsCount) || 100,
    websiteStatus: data.websiteStatus || 'Needs evaluation',
    painPoints: data.painPoints || [],
    targetPitch: data.targetPitch || 'Website Redesign + Review Acceleration',
    estimatedValue: data.estimatedValue || '₹35,000',
...
export function convertProspectToClient(prospectId) {
  ...
  const client = createClient({
    ...
    websiteDomain: `https://${p.businessName.toLowerCase().replace(/[^a-z0-9]/g, '')}.in`,
