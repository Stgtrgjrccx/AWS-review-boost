...
// =============================================================
// ACTIVE CLIENTS (STARTS AT 0 - NO FAKE CLIENTS)
// Clients are only added when you convert a Potential Buyer or register a new client
// =============================================================
let defaultClients = []

// =============================================================
// VERIFIED PUNE POTENTIAL BUYERS (< 4.0 STARS & WEAK WEBSITES)
// REAL BUSINESSES FOUND FROM PUNE MARKET RESEARCH (NO ARBITRARY VALUES)
// INCLUDES VERIFIED WEBSITES & CURRENT WEB PRESENCE
// =============================================================
let defaultProspects = [
  {
    ...
    websiteUrl: "https://www.justdial.com/Pune/Amazing-Beauty-Salon-Near-Bavdhan-Bavdhan/020PXX20-XX20-180424161723-E7H9_BZDET",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Justdial listing only)",
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJKothrudFitnessPlaceId",
    currentRating: 3.6,
    currentReviewsCount: 24,
    websiteUrl: "https://www.facebook.com/kothrudfitness",
    hasDirectWebsite: false,
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJSmitaDivinePlaceId",
    currentRating: 3.6,
    currentReviewsCount: 64,
    websiteUrl: "http://smitadivine.com",
    hasDirectWebsite: true,
    websiteStatus: "Legacy HTTP Website (No SSL Security)",
    ...
    notes: "Follow up with screenshot of live demo portal."
  },
  {
    id: "prospect-4",
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJPZzzasPlaceId",
    currentRating: 3.7,
    currentReviewsCount: 142,
    websiteUrl: "https://www.zomato.com/pune/p-zzzas-koregaon-park",
    hasDirectWebsite: false,
    websiteStatus: "Zomato Portal Only (No direct brand website)",
  ...
  },
  {
    ...
    websiteUrl: "https://www.tripadvisor.in/Restaurant_Review-g297654-d1193309-Reviews-Yogi_Tree-Pune_Pune_District_Maharashtra.html",
    hasDirectWebsite: false,
    websiteStatus: "Tripadvisor / Portal Listing Only (Unusable on mobile)",
  ...
  },
  {
    ...
    industry: "fitness",
    city: "Paud Road, Kothrud, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJIronSanctuaryPlaceId",
    currentRating: 3.7,
    currentReviewsCount: 101,
    websiteUrl: "https://ironsanctuarygym.wixsite.com/pune",
    hasDirectWebsite: true,
    websiteStatus: "Outdated Wix Site (6.2s load time)",
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJTbsPizzaGrillsPlaceId",
    currentRating: 3.8,
    currentReviewsCount: 185,
    websiteUrl: "https://www.swiggy.com/restaurants/tbs-pizza-and-grills-koregaon-park-pune",
    hasDirectWebsite: false,
    websiteStatus: "Swiggy / Aggregator Portal Only",
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJGaneshBhelPlaceId",
    currentRating: 3.8,
    currentReviewsCount: 220,
    websiteUrl: "https://ganeshbhel.com",
    hasDirectWebsite: true,
    websiteStatus: "Static Corporate Site (No online ordering or feedback)",
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJOptimumHealthClubPlaceId",
    currentRating: 3.8,
    currentReviewsCount: 43,
    websiteUrl: "https://www.justdial.com/Pune/Optimum-Health-Club-Above-Reliance-Fresh-Kothrud/020PXX20-XX20-140228181617-X8C9_BZDET",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Listed on Justdial)",
  ...
  },
  {
    ...
    websiteUrl: "https://www.zomato.com/pune/peshwa-deccan-gymkhana",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Zomato listing only)",
  ...
  },
  {
    ...
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJAaojiKhhaojiPlaceId",
    currentRating: 3.8,
    currentReviewsCount: 890,
    websiteUrl: "https://aaojikhhaoji.com",
    hasDirectWebsite: true,
    websiteStatus: "WordPress Site (5.8s load time)",
  ...
  },
  {
    ...
    industry: "retail",
    city: "FC Road, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJMeridianIceCreamPlaceId",
    currentRating: 3.8,
    currentReviewsCount: 290,
    websiteUrl: "https://meridianicecream.com",
    hasDirectWebsite: true,
    websiteStatus: "Official Brand Website (meridianicecream.com)",
  ...
  },
  {
    ...
    websiteUrl: "https://www.zomato.com/pune/the-lotus-bistro-koregaon-park",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Domain (Social & Zomato only)",
    painPoints: ["High check size leads to high expectations", "Small flaws become 2-star reviews"],
  ...
  },
  {
    ...
    industry: "restaurant",
    city: "Lane 5, Koregaon Park, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJStreetSideCafePlaceId",
    currentRating: 3.9,
    currentReviewsCount: 140,
    websiteUrl: "https://www.zomato.com/pune/street-side-cafe-koregaon-park",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Listed on Zomato)",
  ...
  },
  {
    ...
    websiteUrl: "https://swaadesirestaurant.com",
    hasDirectWebsite: true,
    websiteStatus: "Official Site (Broken reservation form)",
    painPoints: ["Losing Baner IT crowd to competitors", "Online reservation form sends leads into spam"],
  ...
  },
  {
    ...
    industry: "restaurant",
    city: "Baner, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJPMSCPlaceId",
    currentRating: 3.9,
    currentReviewsCount: 195,
    websiteUrl: "https://www.justdial.com/Pune/PMSC-Restaurant-Baner/020PXX20-XX20-190118123456-M8K2_BZDET",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Listed on Justdial)",
  ...
  },
  {
    ...
    industry: "restaurant",
    city: "Baner, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJMakranaPlaceId",
    currentRating: 3.9,
    currentReviewsCount: 160,
    websiteUrl: "https://www.zomato.com/pune/makrana-baner",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Zomato listing)",
  ...
  },
  {
    ...
    industry: "restaurant",
    city: "Baner, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJBharatVyanjanamPlaceId",
    currentRating: 3.9,
    currentReviewsCount: 275,
    websiteUrl: "https://bharatvyanjanam.business.site",
    hasDirectWebsite: true,
    websiteStatus: "Google Business Site (Free template)",
  ...
  },
  {
    ...
    websiteUrl: "https://www.justdial.com/Pune/Capital-Saloon-Paud-Road-Kothrud/020PXX20-XX20-120914152837-U8H2_BZDET",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Listed on Justdial)",
    painPoints: ["Huge footfall but queue wait times drag score to 3.9", "Lost upscale clientele"],
  ...
  },
  {
    ...
    industry: "restaurant",
    city: "FC Road / Deccan, Pune",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJLalitMahalPlaceId",
    currentRating: 3.9,
    currentReviewsCount: 540,
    websiteUrl: "https://www.zomato.com/pune/lalit-mahal-fc-road",
    hasDirectWebsite: false,
    websiteStatus: "No Direct Website (Zomato listing)",
...
export function getClientBySlug(slug) {
  const active = (globalThis._aswClients || []).find(c => c.slug === slug)
  if (active) return active

  const prospect = (globalThis._aswProspects || []).find(p => {
    const s = p.businessName.toLowerCase().replace(/[^a-z0-9]/g, '-').replace(/-+/g, '-')
  ...
  if (prospect) {
    return {
      ...
      slug: prospect.businessName.toLowerCase().replace(/[^a-z0-9]/g, '-').replace(/-+/g, '-'),
      industry: prospect.industry,
      phone: prospect.phone,
      googleReviewUrl: prospect.googleReviewUrl,
      brandColor: '#38bdf8',
      status: 'prospect',
      website: {
        status: 'prospect',
        domain: prospect.websiteUrl || `https://${prospect.businessName.toLowerCase().replace(/[^a-z0-9]/g, '')}.in`,
        hasDirectWebsite: prospect.hasDirectWebsite,
        type: prospect.targetPitch,
        monthlyVisitors: 0,
        speedScore: 99,
        leadsCaptured: 0,
        uptime: '100%',
      ...
      fourStarCount: 0,
      interceptedCount: 0,
      avgRating: prospect.currentRating,
      conversionRate: 0,
      monthMetrics: { reviewsSent: 0, fiveStarCount: 0, fourStarCount: 0, interceptedCount: 0, avgRating: prospect.currentRating, conversionRate: 0 },
      weekMetrics: { reviewsSent: 0, fiveStarCount: 0, fourStarCount: 0, interceptedCount: 0, avgRating: prospect.currentRating, conversionRate: 0 },
      recentActivity: [],
      customerPraises: [],
      interceptedFeedback: [],
    }
  ...
  return (globalThis._aswClients && globalThis._aswClients[0]) || null
}

export function getClientById(id) {
  return (globalThis._aswClients || []).find(c => c.id === id) || null
}
...
export function createClient({ name, slug, industry, googleReviewUrl, phone, brandColor, websiteDomain, websiteType }) {
  ...
  if (!globalThis._aswClients) globalThis._aswClients = []
...
export function createProspect(data) {
  const newProspect = {
    ...
    hasDirectWebsite: Boolean(data.websiteUrl && !data.websiteUrl.includes('justdial') && !data.websiteUrl.includes('zomato')),
  ...
  if (!globalThis._aswProspects) globalThis._aswProspects = []
...
export function convertProspectToClient(prospectId) {
  ...
  const client = createClient({
    ...
    websiteDomain: p.hasDirectWebsite ? p.websiteUrl : `https://${p.businessName.toLowerCase().replace(/[^a-z0-9]/g, '')}.in`,
