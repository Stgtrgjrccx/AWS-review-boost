...
let defaultProspects = [
  {
    ...
    email: 'vikram@royalbiryanihouse.com',
    industry: 'restaurant',
    city: 'Bandra, Mumbai',
    googleReviewUrl: 'https://maps.google.com/?q=Royal+Biryani+House',
    currentRating: 3.8,
    currentReviewsCount: 34,
    websiteStatus: 'Broken mobile layout (4.8s load)',
    painPoints: ['Losing food orders to competitor nearby', '1-star reviews from Zomato delivery delays', 'No online menu or table booking'],
    targetPitch: 'Review Gating Shield + Next.js Mobile Menu & Table Booking Portal',
    estimatedValue: '₹35,000 upfront + ₹3,500/mo',
    stage: 'pitch_sent',
    opportunity: 'hot',
    lastContact: 'Yesterday',
    notes: 'Loved the Rustic Table live demo. Asked for pricing on website + QR cards.',
  },
  {
    id: 'prospect-2',
    businessName: 'SmileCraft Dental Studio',
    contactName: 'Dr. Neha Verma',
    contactRole: 'Principal Dentist',
    phone: '+91 98222 33110',
    email: 'drneha@smilecraft.in',
    industry: 'medical',
    city: 'Indiranagar, Bengaluru',
    googleReviewUrl: '',
    currentRating: 4.1,
    currentReviewsCount: 18,
    websiteStatus: 'No website (Only Facebook page)',
    painPoints: ['Patients unable to book appointments online', 'Very low review count despite 10+ patients daily'],
    targetPitch: 'Instant Doctor Booking Website + Post-Consultation WhatsApp Review Dispatch',
    estimatedValue: '₹45,000 upfront + ₹4,000/mo',
    stage: 'demo_scheduled',
    opportunity: 'hot',
    lastContact: 'Today, 11:30 AM',
    notes: 'Demo call scheduled for Friday 3 PM. Show Apex Dental case study.',
  },
  {
    id: 'prospect-3',
    businessName: 'Aura Luxury Wellness & Spa',
    contactName: 'Kavita Singhania',
    contactRole: 'Founder',
    phone: '+91 98333 88776',
    email: 'kavita@auraspa.luxury',
    industry: 'salon',
    city: 'Juhu, Mumbai',
    googleReviewUrl: '',
    currentRating: 4.3,
    currentReviewsCount: 52,
    websiteStatus: 'Outdated WordPress (No SSL certificate)',
    painPoints: ['SSL security warnings scaring wealthy clients', 'Negative reviews about therapist changes'],
    targetPitch: 'High-End Glassmorphic Luxury Website + Private Feedback Vault',
    estimatedValue: '₹55,000 upfront + ₹5,000/mo',
    stage: 'follow_up',
    opportunity: 'high',
    lastContact: '3 days ago',
    notes: 'Follow up on WhatsApp with screenshot of Glow Salon live portal.',
  },
  {
    id: 'prospect-4',
    businessName: 'Urban Fit Athletic Club',
    contactName: 'Rohit Deshmukh',
    contactRole: 'Managing Director',
    phone: '+91 98444 22119',
    email: 'rohit@urbanfitclub.in',
    industry: 'fitness',
    city: 'Koregaon Park, Pune',
    googleReviewUrl: '',
    currentRating: 3.9,
    currentReviewsCount: 41,
    websiteStatus: 'Basic Wix template',
    painPoints: ['Members complaining publicly about gym equipment maintenance', 'Wix site doesn’t sync membership enquiries'],
    targetPitch: 'Gym Tour & Membership Lead Funnel + QR Check-in Review Gating',
    estimatedValue: '₹40,000 upfront + ₹3,000/mo',
    stage: 'new',
    opportunity: 'medium',
    lastContact: 'May 29, 2026',
    notes: 'Cold lead from Instagram ad. Needs introductory outreach message.',
  },
]
